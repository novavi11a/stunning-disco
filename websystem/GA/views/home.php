        ...
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between pb-3 mb-4 border-bottom">
            ...
            <?php } else { ?>
                ...
                <div class="col-md-3 text-end">
                    <button type="button" class="btn btn-outline-primary me-2 "><a class="text-decoration-none text-light" href="../index.php?url=login">Login</a></button>
                    <button type="button" class="btn btn-primary "><a class="text-decoration-none  text-light" href="../index.php?url=signup">Sign-up</a></button>
                </div>
                ...
                <div class="bd-placeholder-img">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            ...
                            <p><a class="btn btn-lg btn-primary" href="../views/shop.php">Goto Shop</a></p>
                        </div>
                    </div>
                </div>
