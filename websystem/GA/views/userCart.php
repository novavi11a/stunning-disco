...
================================================== -->
        ...
        <h1><?=$message?></h1>
            ...
            <table class="table border border-5 rounded-3">
                <thead>
                    ...
                    <tr>
                    <?php include 'partials/itemTable.php';?>
                        <td colspan="4" class="text-center">
                            <a href="home.php" class="btn btn-warning">&nbsp;&nbsp;&nbsp;Back to Shop</a>
                        </td>
    ...
    $('.itemQ').on('change', function(e)
    {
        ...
        var qty = $el.find('.itemQ').val();
        var maxQ = $el.find('.maxQ').val();
        ...
        $.ajax({
            ...
            method: 'POST',
            cache: false,
            data: {pid: pid, pprice: pprice, qty: qty, maxQ: maxQ},
